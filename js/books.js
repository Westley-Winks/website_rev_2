...
const projectCards = Array.from(document.getElementsByClassName("membership"))
...
projectCards.forEach(card => {
    projects.push({
        id: card.id,
        name: card.getElementsByClassName("name-handle")[0].innerText,
        description: card.getElementsByClassName("book-description")[0].innerText,
